    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <x-primary-button tag="a" href="{{ route('book.print') }}" target="blank">Print Buku</x-primary-button>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="flex gap-2">
                            ...
                            <form action="{{ route('book.destroy', $book->id) }}" method="POST">
                                @csrf
                                @method('delete')
                                <x-danger-button onclick="return confirm('Yakin Mau menghapus data ini?')">
                                    Hapus
                                </x-danger-button>
                            </form>
                        </td>
